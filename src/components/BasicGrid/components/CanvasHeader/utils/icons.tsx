...
import { IconSortAlphabetAsc, IconSortAlphabetDesc } from '@salutejs/plasma-icons'
...
export const SORT_ASC_ICON = extractSvg(<IconSortAlphabetAsc />)

export const SORT_DESC_ICON = extractSvg(<IconSortAlphabetDesc />)
export const SORT_DEFAULT_ICON = SORT_ASC_ICON
